...
const people = [
    ...
    { id: 2, name: 'Kennie Mayers' },
    { id: 3, name: 'Jack Reacher' }
    // More users...
]
...
export default function MyComboBox({ workSheetData }: {
    ...
    const onBlur = () => null;
    return (
        <Combobox as="div" className="my-combobox" value={selectedPerson} onChange={setSelectedPerson}>
            ...
            <div className="relative mt-2">
                ...
                >
                    <div className="ms-nav-scrollable thm-cont-g1-bgcolor" style={{ overflow: 'scroll' }}>
                        <WorkSheetBusinessTable workSheetData={workSheetData} onBlur={() => null} />
                    </div>
                </Combobox.Options>
